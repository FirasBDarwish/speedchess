#!/bin/bash
#SBATCH --job-name=alphazero_gate_against_8                   # Default job name (sweep overrides)
...
#SBATCH -o slurm-%x-%j_alphazero_gate_against_8.out                 # STDOUT (%x=jobname, %j=jobid)
#SBATCH -e slurm-%x-%j_alphazero_gate_against_8.err                 # STDERR
...
~/.conda/envs/torch/bin/python train_gate_against_8.py
